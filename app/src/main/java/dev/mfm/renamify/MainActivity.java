...
public class MainActivity extends AppCompatActivity {
    ...
    private void validateInputs() {
        boolean isDirectorySelected = binding.directoryEditText.getText() != null && 
                                      !binding.directoryEditText.getText().toString().trim().isEmpty();
        boolean isBaseNameEntered = binding.baseNameEditText.getText() != null && 
                                    !binding.baseNameEditText.getText().toString().trim().isEmpty();
        boolean isOrderSelected = binding.orderSpinner.getText() != null && 
